  ...
  return (
    ...
    >
      <div className="space-y-12">
        ...
        <section className="bg-gradient-to-br from-[#5B6F8C] to-[#4A5D75] text-white p-8 rounded-lg">
          ...
          <div className="flex gap-4">
            <Link 
              ...
              className="inline-block bg-white text-[#5B6F8C] px-6 py-3 rounded-full font-semibold hover:bg-gray-100 transition-colors"
            >
        ...
        {/* Student Research */}
        <section>
          <h2 className="text-3xl font-bold text-[#5B6F8C] mb-6">Student Research</h2>
          <p className="text-lg text-gray-700 mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              <div className="w-12 h-12 bg-[#5B6F8C]/10 rounded-lg flex items-center justify-center mb-4">
                <svg className="w-6 h-6 text-[#5B6F8C]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
              </div>
              <h3 className="text-xl font-bold text-[#5B6F8C] mb-2">Undergraduate Research</h3>
              <p className="text-gray-700 text-sm mb-4">
                Final year projects and research assignments supervised by experienced faculty members.
              </p>
              <Link href="#" className="text-[#5B6F8C] font-semibold text-sm hover:underline">
                Learn More →
              </Link>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              ...
              <h3 className="text-xl font-bold text-[#5B6F8C] mb-2">Postgraduate Research</h3>
              <p className="text-gray-700 text-sm mb-4">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              ...
              <h3 className="text-xl font-bold text-[#5B6F8C] mb-2">Research Groups</h3>
              <p className="text-gray-700 text-sm mb-4">
          ...
          <div className="bg-gray-50 p-8 rounded-lg">
            <h3 className="text-2xl font-bold text-[#5B6F8C] mb-6">Recent Student Research Highlights</h3>
        ...
        <section className="bg-gray-50 p-8 rounded-lg">
          <h2 className="text-3xl font-bold text-[#5B6F8C] mb-6">Research Support & Resources</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-xl font-bold text-gray-800 mb-4">For Faculty & Staff</h3>
              <ul className="space-y-3">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-[#5B6F8C] mr-3 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
