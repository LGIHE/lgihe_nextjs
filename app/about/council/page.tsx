  ...
  return (
    ...
    >
      <div className="prose prose-lg max-w-none">
        ...
        <h2 className="text-2xl font-bold text-[#3d4d6f] mb-4">Council Responsibilities</h2>
        ...
        <h2 className="text-2xl font-bold text-[#3d4d6f] mb-4">Council Members</h2>
        <div className="space-y-4">
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="bg-gray-50 p-4 rounded-lg flex items-center gap-4">
              ...
              <div>
                <h3 className="font-bold text-[#3d4d6f]">Council Member {i}</h3>
