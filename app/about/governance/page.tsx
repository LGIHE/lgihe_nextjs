      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-xl font-bold text-[#5B6F8C] mb-3">Board of Directors</h3>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-xl font-bold text-[#5B6F8C] mb-3">Academic Council</h3>
            <p className="text-gray-700">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-xl font-bold text-[#5B6F8C] mb-3">Executive Management</h3>
            <p className="text-gray-700">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-xl font-bold text-[#5B6F8C] mb-3">Faculty Senate</h3>
            <p className="text-gray-700">
