  ...
  return (
    ...
    >
      <div className="prose prose-lg max-w-none">
        ...
        <h2 className="text-2xl font-bold text-[#3d4d6f] mb-4">Annual Events</h2>
        <div className="space-y-4 mb-8">
          {[
            ...
            <div key={item.event} className="bg-white border-l-4 border-[#3d4d6f] p-4">
              <h3 className="font-bold text-[#3d4d6f] mb-1">{item.event}</h3>
        ...
        <div className="bg-gradient-to-br from-[#3d4d6f] to-[#2f3d57] text-white p-6 rounded-lg">
          ...
          <a href="/portal" className="inline-block bg-white text-[#3d4d6f] px-6 py-3 rounded-full font-medium hover:bg-gray-100 transition-colors">
            View Calendar
          </a>
        </div>
      </div>
