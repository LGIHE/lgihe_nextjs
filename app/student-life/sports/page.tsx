  ...
  return (
    ...
    >
      <div className="prose prose-lg max-w-none">
        ...
        <h2 className="text-2xl font-bold text-[#5B6F8C] mb-4">Facilities</h2>
        ...
        <h2 className="text-2xl font-bold text-[#5B6F8C] mb-4">Varsity Teams</h2>
        ...
        <div className="flex flex-wrap gap-3">
          {["Football", "Basketball", "Volleyball", "Athletics", "Swimming", "Tennis", "Rugby", "Netball"].map((sport) => (
            <span key={sport} className="bg-[#5B6F8C] text-white px-4 py-2 rounded-full text-sm">
              {sport}
            </span>
          ))}
        </div>
