      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <h3 className="text-xl font-bold text-[#5B6F8C] mb-4">Standard Rooms</h3>
            ...
            <p className="text-2xl font-bold text-[#5B6F8C]">$3,000/year</p>
          </div>

          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <h3 className="text-xl font-bold text-[#5B6F8C] mb-4">En-suite Rooms</h3>
            <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
            ...
            <p className="text-2xl font-bold text-[#5B6F8C]">$5,000/year</p>
          </div>
        </div>

        <div className="bg-[#5B6F8C]/10 p-6 rounded-lg">
          <h3 className="text-xl font-bold text-[#5B6F8C] mb-3">Application Process</h3>
