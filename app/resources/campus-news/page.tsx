  ...
  return (
    ...
    >
      <div className="space-y-8">
        {/* Featured News */}
        <section>
          <div className="bg-gradient-to-br from-[#5B6F8C] to-[#4A5D75] text-white rounded-lg overflow-hidden">
            <div className="grid md:grid-cols-2">
              <div className="p-8 md:p-12 flex flex-col justify-center">
                ...
                <Link 
                  href="#" 
                  className="inline-block bg-white text-[#5B6F8C] px-6 py-3 rounded-full font-semibold hover:bg-gray-100 transition-colors w-fit"
                >
                  Read Full Story
                </Link>
              </div>
        ...
        {/* Latest News */}
        <section>
          <h2 className="text-3xl font-bold text-[#5B6F8C] mb-6">Latest News</h2>
            ...
            {newsArticles.map((article) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <Link 
                    href="#" 
                    className="text-[#5B6F8C] font-semibold text-sm hover:underline"
                  >
                    Read More →
                  </Link>
                </div>
        ...
        <section className="bg-gray-50 p-8 rounded-lg">
          <h2 className="text-2xl font-bold text-[#5B6F8C] mb-6">Browse by Category</h2>
          <div className="grid md:grid-cols-4 gap-4">
            {["Academic", "Research", "Student Life", "Events", "Partnerships", "Awards", "Community", "Announcements"].map((category) => (
              <Link 
                key={category}
                href="#"
                className="bg-white p-4 rounded-lg border border-gray-200 text-center hover:border-[#5B6F8C] hover:shadow-md transition-all"
              >
                <span className="font-semibold text-[#5B6F8C]">{category}</span>
              </Link>
            ))}
          </div>
        </section>
