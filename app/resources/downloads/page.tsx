    ...
    >
      <div className="space-y-12">
              ...
              {category.items.map((item, itemIndex) => (
                ...
                >
                  <div className="flex items-center gap-4 flex-1">
                    <div className="w-12 h-12 bg-[#5B6F8C]/10 rounded-lg flex items-center justify-center">
                  ...
                  <button className="flex items-center gap-2 bg-[#5B6F8C] text-white px-6 py-2.5 rounded-lg hover:bg-[#4A5D75] transition-colors">
        ...
        <section className="bg-gray-50 p-8 rounded-lg">
          <h2 className="text-2xl font-bold text-[#5B6F8C] mb-4">Need Help?</h2>
