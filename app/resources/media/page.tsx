  ...
  return (
    ...
    >
      <div className="space-y-12">
        {/* Photo Galleries */}
        <section>
          <h2 className="text-3xl font-bold text-[#5B6F8C] mb-6">Photo Galleries</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {mediaGalleries.map((gallery, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-[#5B6F8C] group-hover:scale-110 transition-transform duration-300"></div>
              </Link>
            ))}
          </div>
        </section>
        ...
        {/* Video Library */}
        <section>
          <h2 className="text-3xl font-bold text-[#5B6F8C] mb-6">Video Library</h2>
                ...
                <div className="relative aspect-video bg-gray-300">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <button className="w-16 h-16 bg-white/90 rounded-full flex items-center justify-center hover:bg-white transition-colors">
                      <svg className="w-8 h-8 text-[#5B6F8C] ml-1" fill="currentColor" viewBox="0 0 24 24">
        ...
        <section className="bg-gray-50 p-8 rounded-lg">
          <h2 className="text-3xl font-bold text-[#5B6F8C] mb-6">Follow Us on Social Media</h2>
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <a 
              ...
              className="bg-white p-6 rounded-lg border border-gray-200 text-center hover:border-[#5B6F8C] hover:shadow-md transition-all"
            >
              <svg className="w-8 h-8 mx-auto mb-3 text-[#5B6F8C]" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
              <span className="font-semibold text-[#5B6F8C]">Facebook</span>
            </a>
            <a 
            ...
            >
              ...
              <span className="font-semibold text-[#5B6F8C]">Twitter</span>
            </a>
            <a 
            ...
            >
              ...
              <span className="font-semibold text-[#5B6F8C]">LinkedIn</span>
            </a>
            <a 
            ...
            >
              ...
              <span className="font-semibold text-[#5B6F8C]">YouTube</span>
            </a>
          </div>
        </section>
