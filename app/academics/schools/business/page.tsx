    ...
    >
      <div className="prose prose-lg max-w-none">
        ...
        <div className="bg-blue-50 border-l-4 border-[#3d4d6f] p-6 mb-8">
          <h3 className="text-lg font-semibold text-[#3d4d6f] mb-2">Our Programmes</h3>
          <div className="space-y-3 mt-4">
            <div>
              ...
              <a href="/academics/programmes/diploma-leadership" className="text-[#3d4d6f] text-sm hover:underline">
                View Details →
              </a>
            </div>
            <div className="pt-3 border-t border-gray-200">
              ...
              <a href="/academics/programmes/pgd-leadership" className="text-[#3d4d6f] text-sm hover:underline">
                View Details →
              </a>
            </div>
          </div>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-[#3d4d6f] mb-4">Programme Focus Areas</h2>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-white border border-gray-200 rounded-lg p-5">
              <h3 className="text-lg font-bold text-[#3d4d6f] mb-2">Strategic Planning</h3>
              <p className="text-sm text-gray-700">
                Developing vision, mission, and strategic direction for educational institutions
              </p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-5">
              <h3 className="text-lg font-bold text-[#3d4d6f] mb-2">Resource Management</h3>
              <p className="text-sm text-gray-700">
                Effective allocation and management of human, financial, and physical resources
              </p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-5">
              <h3 className="text-lg font-bold text-[#3d4d6f] mb-2">Instructional Leadership</h3>
              <p className="text-sm text-gray-700">
                Leading teaching and learning processes for improved student outcomes
              </p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-5">
              <h3 className="text-lg font-bold text-[#3d4d6f] mb-2">Quality Assurance</h3>
              <p className="text-sm text-gray-700">
                Implementing systems for monitoring and improving educational quality
              </p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-5">
              <h3 className="text-lg font-bold text-[#3d4d6f] mb-2">Community Partnerships</h3>
              <p className="text-sm text-gray-700">
                Building and maintaining relationships with stakeholders and communities
              </p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-5">
              <h3 className="text-lg font-bold text-[#3d4d6f] mb-2">Policy & Governance</h3>
              <p className="text-sm text-gray-700">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-[#3d4d6f] mb-4">Who Should Enroll</h2>
        ...
        <div className="bg-gray-50 p-8 rounded-lg mb-10">
          <h3 className="text-xl font-bold text-[#3d4d6f] mb-4">Programme Features</h3>
