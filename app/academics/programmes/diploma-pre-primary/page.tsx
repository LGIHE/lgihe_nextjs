...
export default function DiplomaPrePrimaryPage() {
  return (
    <PageTemplate 
      title="Diploma in Education Pre-Primary (DEPP)" 
      subtitle="Professional qualification for pre-primary education"
    >
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            The Diploma in Education Pre-Primary (DEPP) is a comprehensive programme designed to prepare 
            professional educators for teaching in pre-primary settings. The programme combines theoretical 
            knowledge with practical teaching experience, ensuring graduates are well-equipped to facilitate 
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700">
            <li>Pre-primary school teachers</li>
            <li>Early childhood education coordinators</li>
            <li>Nursery school administrators</li>
        ...
        <div className="bg-[#5B6F8C] text-white p-8 rounded-lg text-center">
          ...
          <p className="mb-6">Join LGIHE and become a certified pre-primary educator.</p>
