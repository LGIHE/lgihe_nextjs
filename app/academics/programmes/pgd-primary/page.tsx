  ...
  return (
    ...
    >
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-[#3d4d6f] mb-4">Admission Requirements</h2>
          <ul className="list-disc list-inside space-y-2 text-gray-700">
        ...
        <section className="mb-8">
          ...
          <div className="bg-gray-50 p-6 rounded-lg space-y-3">
            <div>
              <h4 className="font-semibold text-[#3d4d6f]">Session I: August – December</h4>
              <p className="text-sm text-gray-600">12 weeks of lectures, continuous assessment, and practicum</p>
            </div>
            <div>
              <h4 className="font-semibold text-[#3d4d6f]">Session II: January – March</h4>
              <p className="text-sm text-gray-600">12 weeks of lectures, continuous assessment, and practicum</p>
            </div>
            <div>
              <h4 className="font-semibold text-[#3d4d6f]">Session III: April – July</h4>
