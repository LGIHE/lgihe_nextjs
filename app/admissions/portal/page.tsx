  ...
  return (
    ...
    >
      <div className="prose prose-lg max-w-none">
        ...
        <h2 className="text-2xl font-bold text-[#3d4d6f] mb-4">Before You Begin</h2>
        ...
        <div className="bg-[#3d4d6f]/10 p-6 rounded-lg">
          ...
          <p className="text-gray-700">
            Contact our admissions team at <a href="mailto:admissions@lgihe.edu" className="text-[#3d4d6f] underline">admissions@lgihe.edu</a> or 
